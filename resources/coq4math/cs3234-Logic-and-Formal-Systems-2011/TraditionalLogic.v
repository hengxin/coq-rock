...
Axiom SomeAnimalsAreNotCats : holds (Some animals are not cats).

Lemma SomeNonCatsAreNotNonAnimals : holds (Some (non cats) are not (non animals)).
...
Lemma SomeNonCatsAreNotNonAnimals2 : holds (Some (non cats) are not (non animals)).
